 ...
 */
public class HighAxisButton extends Button {
     ...
     *
     */
    public HighAxisButton(Joystick stick) {
        joystick = stick;
    }
     ...
     *
     */
    public HighAxisButton(Joystick stick, int axis) {
        joystick = stick;
        this.axis = axis;
    }
     ...
     * @param stick the joystick to read
     * @param axis the raw axis to read
     * @param trigger the trigger value - true if greater than this value
     *
     */
     public HighAxisButton(Joystick stick, int axis, double trigger) {
        joystick = stick;
        this.axis = axis;
     ...
     *
     * @return true if the axis is greater than the trigger value
     */
    public boolean get() {
